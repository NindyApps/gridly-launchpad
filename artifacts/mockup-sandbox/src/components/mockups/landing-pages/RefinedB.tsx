      ...
      <section id="how-it-works" className="py-24 relative z-10">
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8 relative">
            {/* Connecting Line */}
            <div className="hidden md:block absolute top-[40px] left-[15%] right-[15%] h-[1px] bg-gradient-to-r from-transparent via-emerald-500/30 to-transparent"></div>
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              <div key={i} className="bg-white/[0.02] border border-white/5 rounded-2xl p-8 backdrop-blur-sm relative overflow-hidden group">
                {/* Accent line */}
        ...
        <div className="container mx-auto px-6 max-w-3xl">
          ...
          <div className="space-y-4">
            {faqs.map((faq, i) => (
              <div 
                key={i} 
                className={`border border-white/5 rounded-xl overflow-hidden transition-colors ${faqOpen === i ? 'bg-white/[0.04]' : 'bg-transparent hover:bg-white/[0.02]'}`}
              >
                <button 
