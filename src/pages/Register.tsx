...
const Register = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // 3. Create workspace via edge function (uses service role to bypass RLS)
        ...
        {step === 1 && (
          <div className="space-y-5">
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input placeholder="Jane Smith" value={displayName} onChange={(e) => setDisplayName(e.target.value)} className="pl-10" required />
                </div>
              </div>
              <div className="space-y-2">
                <Label>Email</Label>
            ...
            <Button
              className="w-full"
              onClick={() => setStep(2)}
              disabled={!email || !password || password.length < 6 || !displayName}
            >
