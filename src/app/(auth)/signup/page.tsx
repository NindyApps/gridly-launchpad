    ...
    <div className="min-h-screen bg-zinc-950 flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md space-y-6">
        <div className="text-center">
          ...
          <p className="text-zinc-400 text-sm mt-1">Start finding buyers in 5 minutes</p>
        </div>
        ...
        <form onSubmit={handleSignup} className="space-y-4">
          <div className="space-y-2">
            <Label htmlFor="full-name" className="text-zinc-300 text-sm">Full Name</Label>
            <Input
              id="full-name"
              type="text"
          ...
          <div className="space-y-2">
            ...
            {password && (
              <div className="space-y-1.5">
                ...
                <p className={cn("text-xs", strength.score <= 1 ? "text-red-400" : strength.score <= 3 ? "text-yellow-400" : "text-green-400")}>
                  {strength.label}
                </p>
              </div>
            )}
